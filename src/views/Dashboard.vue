<template>
  <div>
    <h1 class="subheading grey--text text--lighten-1">Dashboard</h1>
    <v-container >
      <v-row class="d-flex">
        <v-col class="pa-0 ma-0" cols="12" sm="6" md="6" lg="3">
          <v-card class="ma-3">
            <v-list-item>
      ...
      <v-row>
        <v-col class="pa-0 ma-0" cols="12" sm="6" md="4" lg="3" v-for="person in team" :key="person.name">
